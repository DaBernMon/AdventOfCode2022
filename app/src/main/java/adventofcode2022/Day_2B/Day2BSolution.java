package adventofcode2022.Day_2B;
...
/**
 * This is the solution for part 2 of day 2's problem.
 * 
 ...
 * 
 * This is basically the same as part 1, but we know without any 'if' block, the round
 * score (win, lose, draw) but have to calculate (in my lazy way with 'if' blocks)
 * the score for your choice.
 * 
 ...
 */
public class Day2BSolution {
    private static String INPUT_NAME = "Day_2B/input.txt";
    ...
    public void Solve() {
        ...
        System.out.println("Solution for problem 2, part 2: " + totalScore);
    }
    ...
    private int calculateScoreForRound(String roundInput) {
        ...
        // First, award points for the round result
        // This converts
        // X -> 0, Y -> 3, Z -> 6
        score = (yourChoice - 'X') * 3;
