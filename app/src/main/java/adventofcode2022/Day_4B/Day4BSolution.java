package adventofcode2022.Day_4B;
...
/**
 * This is the solution for part 2 of day 4's problem.
 * 
 ...
 * 5a. If smaller min's length > difference, some overlap, increment total, go to next line
 * 5b. If smaller min's length <= difference, no overlap, go to next line
 * 
 ...
 */
public class Day4BSolution {
    private static String INPUT_NAME = "Day_4B/input.txt";
    ...
    public void Solve() {
        ...
        for (String line: getInputData()) {
            ...
            if (range1.length > minDiff) {
                total++;
            }
        }
        System.out.println("Solution for problem 4, part 2: " + total);
    }
